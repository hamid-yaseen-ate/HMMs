...
ctypedef numpy.int64_t int_t # jclarkbell:dtype_fix
...
cdef class DtHMM:
    ...
    cpdef viterbi(self, numpy.ndarray[int_t, ndim=1] e_seq):
        ...
        cdef numpy.ndarray[int_t, ndim=2] psi = numpy.empty( (size,states_num), dtype=numpy.int64 ) #numpy.zeros( (size, states_num )) # jclarkbell:dtype_fix
        ...
        cdef numpy.ndarray[int_t, ndim=1] path = numpy.full( size, 0, dtype=numpy.int64 ) # jclarkbell:dtype_fix
